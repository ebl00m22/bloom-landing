...
const BENEFITS = [
  {
    ...
    body: "We study how you think and sound. Every post sounds like you wrote it.",
  },
  {
    icon: UsersIcon,
    title: "One monthly review",
    body: "See your full content calendar on the 15th. Approve in 30 minutes.",
  },
  {
    icon: ChartIcon,
    title: "Results you can measure",
    body: "Impressions, DMs, inbound leads. We report on what moves the needle.",
  },
];
...
const STEPS = [
  { n: "01", title: "Strategy Call", body: "We learn your voice and goals." },
  { n: "02", title: "Monthly Calendar", body: "Full content plan on the 15th." },
  { n: "03", title: "You Approve", body: "30 minutes in Monday.com." },
  { n: "04", title: "We Publish", body: "Posting, engagement, and monthly reporting. Done." },
];
...
const TESTIMONIALS = [
  ...
  {
    quote: "They captured my voice from day one. My own team asks if I wrote the posts myself.",
    name: "Sarah T.",
    title: "Founder, HR Consulting",
  },
  {
    quote: "Three enterprise clients in six months, all from LinkedIn content Bloom created.",
    name: "David M.",
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-10 max-w-lg mx-auto">
              Book a free 30-minute call. We will look at your LinkedIn and show you exactly what is possible.
            </p>
            <Link
              href="/contact"
