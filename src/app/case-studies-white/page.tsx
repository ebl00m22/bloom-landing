...
function BigStat({ end, suffix, label, index }: { end: number; suffix?: string; label: string; index: number }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-[#0c0a14]/35 text-xs tracking-wide leading-snug">{label}</p>
    </motion.div>
  );
}
    ...
    <main className="overflow-x-hidden bg-white">
      ...
      <section className="relative pt-36 pb-24 overflow-hidden bg-[#f8faf9]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            <motion.h1
              className="text-[clamp(2.8rem,6vw,5rem)] font-extrabold text-[#0c0a14] leading-[1.05] tracking-tight mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.65, delay: 0.1 }}
            >
              The work speaks<br />
              <span className="text-[#0c0a14]/25">for itself.</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.25 }}
              className="text-lg text-[#0c0a14]/45 leading-relaxed"
            >
      ...
      <section className="pb-8 bg-white pt-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <span className="text-[#0c0a14]/20 text-xs font-bold tracking-widest uppercase">01</span>
          ...
          >
            ...
            <div className="px-8 md:px-14 pt-12 pb-10 border-b border-[#0c0a14]/[0.06] bg-[#f8faf9]">
              <p className="text-[#0c0a14]/35 text-sm mb-2">Nena Shimp · Fractional CFO & Business Strategist</p>
              <h2 className="text-3xl md:text-5xl font-extrabold text-[#0c0a14] leading-[1.1] tracking-tight max-w-2xl">
            ...
            <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[#0c0a14]/[0.06]">
              ...
              >
                <p className="text-[#0c0a14]/25 text-[10px] font-bold tracking-[0.25em] uppercase mb-6">Before Bloom</p>
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-sm text-[#0c0a14]/40 leading-relaxed">
              ...
              >
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-sm text-[#0c0a14]/70 leading-relaxed">
            ...
            <div className="px-8 md:px-14 py-14 bg-[#edf5f4] border-t border-[#0c0a14]/[0.06]">
              <p className="text-[#0c0a14]/25 text-[10px] font-bold tracking-[0.25em] uppercase mb-10 text-center">90-Day Results</p>
              ...
              <p className="text-center text-[#0c0a14]/30 text-xs mt-10 leading-relaxed">
                Her top post alone reached <span className="text-[#0c0a14]/60 font-semibold">12,000+ people</span> — no paid promotion.
              </p>
            </div>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  <span className="text-[#0c0a14]/15 text-xs font-bold tracking-widest uppercase">{cs.n}</span>
                  <div className="h-px flex-1 bg-[#0c0a14]/[0.06]" />
                  <span className="px-2.5 py-1 rounded-full bg-[#0c0a14]/[0.05] text-[#0c0a14]/25 text-[10px] font-bold tracking-widest uppercase">Coming Soon</span>
                </div>
                <p className="text-[#0c0a14]/20 text-[10px] font-bold tracking-widest uppercase mb-2">{cs.service}</p>
                <h3 className="text-xl font-bold text-[#0c0a14]/25 mb-1">{cs.client}</h3>
                <p className="text-[#0c0a14]/15 text-xs mb-8">{cs.industry}</p>
                <p className="text-2xl font-black text-[#0c0a14]/20">{cs.teaser}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-[#edf5f4]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <blockquote className="text-xl md:text-2xl font-semibold text-[#0c0a14]/60 leading-relaxed mb-8 max-w-2xl mx-auto">
            ...
            <p className="text-[#0c0a14]/50 font-bold text-sm">Cheryl Welch</p>
            <p className="text-[#0c0a14]/25 text-xs mt-1">Corewell Health</p>
          </motion.div>
        </div>
      </section>
